...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=100, y=23, width=430, height=430)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=700, y=50, width=430, height=430)
